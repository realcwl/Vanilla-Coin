...
public class Transaction {
    ...
    public byte[] getRawDataToSign(int index) {
        // ith input and all outputs (ith input's transaction hash and its hash index, value + address for each output, form a single byte array)
    ...
    public byte[] getRawTx() {
        /* get raw byte data implementation of transaction */
